...
{
    case '0' :
        $comments = modCommentsUgc::getLatestComments($params);
        require (JModuleHelper::getLayoutPath('mod_comments_ugc', 'comments'));
        break;

    case '1' :
        $commenters = modCommentsUgc::getTopCommenters($params);
        require (JModuleHelper::getLayoutPath('mod_comments_ugc', 'commenters'));
        break;
}
