...
if ($feed != false)
{
	...
	?>
	<div style="direction: <?php echo $rssrtl ? 'rtl' :'ltr'; ?>; text-align: <?php echo $rssrtl ? 'right' :'left'; ?> ! important"  class="<?php echo $rssrtl ? 'rtl' :'ltr'; ?> feed<?php echo $moduleclass_sfx; ?>">
	<?php
	// feed description
	...
	?>
			...
			for ($j = 0; $j < $totalItems; $j ++)
			{
				...
				<a class="feed-link" href="<?php echo $currItem->get_link(); ?>" target="_blank">
