...
<?php
	$files[] = JHtml::_('stylesheet', 'templates/'.$this->template.'/css/bootstrap.min.css', null, false, true);
	$files[] = JHtml::_('stylesheet', 'templates/'.$this->template.'/css/main.css', null, false, true);
	if ($files):
		if (!is_array($files)):
			$files = array($files);
		endif;
