...
function pagination_item_active(&$item) {
	...
	if ($item->text == JText::_('JPREV')) {
		$display = '<span><i class="icon-left"></i></span>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT')) {
		$display = '<span><i class="icon-right"></i></span>';
	}
...
//		return '<li class="disabled"><span>&raquo;</span></li>';
	...
	// Check for "Prev" item
	if ($item->text == JText::_('JPREV')) {
		return '<li class="disabled"><span><i class="icon-left"></i></span></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT')) {
		return '<li class="disabled"><span><i class="icon-right"></i></span></li>';
	}
