...
<div class="<?php echo $J2gridRow; ?>">
	<?php if ($this->params->get('allow_registration', 1) || $this->params->get('allow_guest_checkout', 0)): ?>
		<div class="<?php echo $J2gridCol; ?>6 left">
			<h3><?php echo JText::_('J2STORE_CHECKOUT_NEW_CUSTOMER'); ?></h3>
	...
	<?php if ($this->params->get('show_login_form', 1)): ?>
		<div id="login" class="<?php echo $J2gridCol; ?>6 right form-horizontal">
			<h3><?php echo JText::_('J2STORE_CHECKOUT_RETURNING_CUSTOMER'); ?></h3>
			<div class="form-group">
				<label for="email" class="col-sm-3 control-label">
					<?php echo JText::_('J2STORE_CHECKOUT_USERNAME'); ?>
				</label>
				<div class="col-sm-9">
					<input type="text" id="email" name="email" value="" class="form-control" onkeypress="return loginKeyPress(event);"/>
				</div>
			</div>
			<div class="form-group">
				<label for="password" class="col-sm-3 control-label">
					<?php echo JText::_('J2STORE_CHECKOUT_PASSWORD'); ?>
				</label>
				<div class="col-sm-9">
					<input type="password" id="password" name="password" class="form-control" value="" onkeypress="return loginKeyPress(event);" />
				</div>
			</div>
			...
			$register_link = JRoute::_('index.php?option=com_users&view=register');
			?>
			<a href="<?php echo $forgot_pass_link; ?>" target="_blank"><?php echo JText::_('J2STORE_FORGOT_YOUR_PASSWORD'); ?></a><br />
			<a href="<?php echo $register_link; ?>" target="_blank"><?php echo JText::_('J2STORE_CHECKOUT_REGISTER'); ?></a>
		</div>
	</div>
<?php endif; ?>
