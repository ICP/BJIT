...
<div class="page user profile<?php echo $this->pageclass_sfx ?>">
	<?php if (JFactory::getUser()->id == $this->data->id) { ?>
		<div class="page-tools">
			<a class="btn btn-warning" href="<?php echo JRoute::_('index.php?option=com_users&task=profile.edit&user_id=' . (int) $this->data->id); ?>">
				<i class="icon-edit"></i> <?php echo JText::_('COM_USERS_EDIT_PROFILE'); ?></a>
			<a class="btn btn-warning" href="<?php echo JRoute::_('index.php?option=com_users&view=logout'); ?>">
