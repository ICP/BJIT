...
?><html class="no-js<?php echo $helper->getBaseClasses($app->getMenu()); ?>" lang="<?php echo $lang; ?>">
	<head>
		...
		<?php if ($isFrontpage) { ?><meta property="og:image" content="<?php echo JURI::base() . 'assets/data/placeholder_tehran.jpg'; ?>">
<?php } ?>
		<?php
		...
		$this->_styleSheets[JURI::base() . 'assets/css/pda.css?_=20180805'] = array('mime' => "text/css");
