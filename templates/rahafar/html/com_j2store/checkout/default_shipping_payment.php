...
<?php if ($this->params->get('show_customer_note', 1)): ?>
	<div class="customer-note">
		...
		<textarea name="customer_note" rows="3" cols="40" class="form-control"></textarea>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('J2STORE_CLOSE'); ?></button>
				</div>
			</div>
		</div>
	</div>
