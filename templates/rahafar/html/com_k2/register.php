...
<div class="page user registration<?php echo $this->pageclass_sfx ?>">
	<form action="<?php echo version_compare(JVERSION, '3.0', 'ge') ? JRoute::_('index.php?option=com_users&task=registration.register') : JURI::root(true) . '/index.php'; ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
		<div class="form-group">
			<div class="control-label col-sm-2">
				<label id="namemsg" for="name"><span class="star red">&#160;*</span> الزامی</label>
			</div>
		...
		<div class="form-group">
			<div class="control-label col-sm-2">
				<label id="namemsg" for="username"><?php echo JText::_('K2_USER_NAME'); ?><span class="star">&#160;*</span></label>
			</div>
			<div class="col-sm-6">
				<input type="text" id="username" name="<?php echo $this->usernameFieldName; ?>" size="40" value="<?php echo $this->escape($this->user->get('username')); ?>" class="inputbox required validate-username" maxlength="25" required />
			</div>
		</div>
		<div class="form-group">
			<div class="control-label col-sm-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" id="email2" name="jform[email2]" size="40" value="" class="inputbox required validate-email" maxlength="100" required />
			</div>
		</div>
		<div class="form-group">
			<div class="control-label col-sm-2">
		...
		<?php if ($this->K2Params->get('recaptchaOnRegistration') && $this->K2Params->get('recaptcha_public_key')) { ?>
			<div class="form-group">
				<div class="control-label col-sm-2">
					<label id="urlmsg" for="url">کد امنیتی (Captcha)<span class="star">&#160;*</span></label>
				</div>
				<div class="col-sm-6">
					<div id="captcha" class="g-recaptcha required" data-sitekey="<?php echo $this->K2Params->get('recaptcha_public_key'); ?>" data-theme="" data-size="normal"></div>
				</div>
			</div>
		<?php } ?>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<button class="btn btn-default validate" type="submit"><?php echo JText::_('K2_REGISTER'); ?></button>
			</div>
		</div>
