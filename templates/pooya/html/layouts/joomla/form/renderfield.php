...
$input = str_ireplace('class="', 'class="form-control ', $input);
$input = str_ireplace('rows="10"', 'rows="5"', $input);
$label = str_ireplace('class="hasPopover', 'class="hasPopover col-sm-2 ', $label);
$label = str_ireplace('class="hasTooltip', 'class="hasPopover col-sm-2 ', $label);
