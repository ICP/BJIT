...
$isregister = $this->params->get('isregister', 0);
$allow = true;
...
?>
<?php if($allow): ?>
<div class="col-xs-12 col-md-8 j2store-product j2store-product-<?php echo $this->product->j2store_product_id; ?> product-<?php echo $this->product->j2store_product_id; ?> <?php echo $this->product->product_type; ?> default">
