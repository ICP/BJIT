...
<?php //Opengraph Support
$og = '<meta property="og:title" content="'.$this->item->title.'" />';
$og .= '<meta property="og:type" content="article" />';
$og .= '<meta property="og:image" content="'.JURI::base().$this->item->image.'" />';
$og .= '<meta property="og:url" content="'.JURI::base().$this->item->link.'" />';
...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php endif; ?>
	<?php //If author alias is available show it, otherwise do nothing -- Farid ?>
	<?php if($this->item->created_by_alias): ?>
	  <div class="author-alias">Written by:&nbsp;
...
<?php endif; ?>
	...
	<div class="itemSocialSharing">
		...
		<?php if($this->item->params->get('itemFacebookButton',1)): ?>
			...
			<div class="itemFacebookButton" style="width: 75px;">
				<?php /*
				<div id="fb-root"></div>
				...
				<div class="fb-like" type="button_count" data-send="false" data-width="200" data-show-faces="true"></div>
				*/ ?>
				<div id='fb-root'></div>
				<script>
					window.fbAsyncInit = function() {
						FB.init({appId: '177111755694317', status: true, cookie: true, xfbml: true});
					};
					(function() {
				...
				<fb:like action='like' colorscheme='light' expr:href='data:Post.url' layout='button_count' show_faces='true' width='500'/>
			</div>
			
			<!-- Facebook share button -->
			<div style="float:left; margin: 0 10px 0 0; width: 130px;"><a name="fb_share" type="button_count" expr:share_url='data:post.url' href="http://www.facebook.com/sharer.php">&nbsp;</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script></div>
		<?php endif; ?>
